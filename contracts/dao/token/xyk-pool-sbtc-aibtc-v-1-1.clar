...
(define-public (create-pool
  ...
  (let ((caller contract-caller))
    (begin
      ...
      (asserts! (is-eq caller CORE_ADDRESS) ERR_NOT_AUTHORIZED)
      (asserts! (is-eq core-caller CONTRACT_DEPLOYER)
