  ...
  (define-public (buy (ft <faktory-token>) (ubtc uint))
    (begin
      ...
      (let
        ...
        (try! (contract-call? 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.sbtc-token transfer pre-fee tx-sender .aibtc-pre-faktory none)) 
        ...
        (if (>= new-stx TARGET_STX)
          (let ((premium-amount (/ (* new-ft (var-get premium)) u100))
            ...
            (try! (as-contract (contract-call? 'STTWD9SPRQVD3P733V89SV0P8RZRZNQADG034F0A.xyk-core-v-1-2 create-pool .xyk-pool-sbtc-aibtc-v-1-1 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.sbtc-token ft amm-ustx amm-amount xyk-burn-amount u10 u40 u10 u40 'ST27Q7Z7P5MTJN2B3M9Q406XPCDB1VFZJ3KWX3CES xyk-pool-uri true))) ;; here 'ST27Q7Z7P5MTJN2B3M9Q406XPCDB1VFZJ3KWX3CES replaced of ST295MNE41DC74QYCPRS8N37YYMC06N6Q3VQDZ6G1
