...
test_api_by_type_subtype() {
    ...
    test_cors "/api/by-type-subtype/BASE/DAO" "By type/subtype endpoint CORS"
    test_endpoint "/api/by-type-subtype/BASE/DAO" 200 "By type/subtype endpoint with valid values"
