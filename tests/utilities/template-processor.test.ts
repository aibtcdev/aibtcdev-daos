...
`;
    ...
    expect(processed).toContain("(define-constant ACCOUNT_OWNER 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM)");
    expect(processed).toContain("(define-constant ACCOUNT_AGENT 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG)");
    
    // Regular lines should remain unchanged
    expect(processed).toContain("(define-constant UNCHANGED_VALUE 'some-value)");
  });
