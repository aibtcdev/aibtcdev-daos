...
export function generateTemplateReplacements(
  ...
  const replacements: Record<string, string> = {
    ...
    // SIP traits
    [`${traits.STANDARD_SIP010}/base_sip010_trait`]: traits.STANDARD_SIP010,
    ...
    [`.aibtc-dao-traits.token-owner/dao_token_owner_trait`]: traits.DAO_TOKEN_OWNER,
    ...
    [`.dao-run-cost/base_dao_run_cost_contract`]: `.${tokenSymbol}-dao-run-cost`,
